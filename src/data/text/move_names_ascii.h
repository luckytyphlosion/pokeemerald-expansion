const u8 gMoveNamesAscii[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    [MOVE_NONE] = "-",
    [MOVE_POUND] = "Pound",
    ...
    [MOVE_PHANTOM_FORCE] = "PhantomForce",
    [MOVE_TRICK_OR_TREAT] = "Halloween",
    [MOVE_NOBLE_ROAR] = "Noble Roar",
    [MOVE_ION_DELUGE] = "Ion Deluge",
    [MOVE_PARABOLIC_CHARGE] = "Parabolic Ch",
    [MOVE_FORESTS_CURSE] = "ForestsCurse",
    [MOVE_PETAL_BLIZZARD] = "Petal Storm",
    [MOVE_FREEZE_DRY] = "Freeze-Dry",
    [MOVE_DISARMING_VOICE] = "Disarming Vo",
    [MOVE_PARTING_SHOT] = "Parting Shot",
    [MOVE_TOPSY_TURVY] = "Topsy-Turvy",
    [MOVE_DRAINING_KISS] = "DrainingKiss",
    [MOVE_CRAFTY_SHIELD] = "CraftyShield",
    [MOVE_FLOWER_SHIELD] = "FlowerShield",
    [MOVE_GRASSY_TERRAIN] = "GrassTerrain",
    [MOVE_MISTY_TERRAIN] = "MistyTerrain",
    ...
    [MOVE_DIAMOND_STORM] = "DiamondStorm",
    [MOVE_STEAM_ERUPTION] = "Steam Erupt",
    [MOVE_HYPERSPACE_HOLE] = "Hyperspace H",
    [MOVE_WATER_SHURIKEN] = "Water Shuri",
    [MOVE_MYSTICAL_FIRE] = "MysticalFire",
    [MOVE_SPIKY_SHIELD] = "Spiky Shield",
    [MOVE_AROMATIC_MIST] = "AromaticMist",
    [MOVE_EERIE_IMPULSE] = "EerieImpulse",
    [MOVE_VENOM_DRENCH] = "Venom Drench",
    [MOVE_POWDER] = "Powder",
    [MOVE_GEOMANCY] = "Geomancy",
    [MOVE_MAGNETIC_FLUX] = "MagneticFlux",
    [MOVE_HAPPY_HOUR] = "Happy Hour",
    [MOVE_ELECTRIC_TERRAIN] = "Electric Ter",
    [MOVE_DAZZLING_GLEAM] = "Dazzling Gle",
    [MOVE_CELEBRATE] = "Celebrate",
    [MOVE_HOLD_HANDS] = "Hold Hands",
    [MOVE_BABY_DOLL_EYES] = "BabyDollEyes",
    [MOVE_NUZZLE] = "Nuzzle",
    [MOVE_HOLD_BACK] = "Hold Back",
    [MOVE_INFESTATION] = "Infestation",
    [MOVE_POWER_UP_PUNCH] = "PowerUpPunch",
    [MOVE_OBLIVION_WING] = "OblivionWing",
    [MOVE_THOUSAND_ARROWS] = "Thousand Ar",
    [MOVE_THOUSAND_WAVES] = "Thousand Wav",
    [MOVE_LANDS_WRATH] = "Lands Wrath",
    [MOVE_LIGHT_OF_RUIN] = "LightOfRuin",
    [MOVE_ORIGIN_PULSE] = "Origin Pulse",
    [MOVE_PRECIPICE_BLADES] = "Precipice Bl",
    [MOVE_DRAGON_ASCENT] = "DragonAscent",
    [MOVE_HYPERSPACE_FURY] = "Hyperspace F",
    [MOVE_SHORE_UP] = "Shore Up",
    [MOVE_FIRST_IMPRESSION] = "First Impres",
    [MOVE_BANEFUL_BUNKER] = "Baneful Bunk",
    [MOVE_SPIRIT_SHACKLE] = "Spirit Shack",
    [MOVE_DARKEST_LARIAT] = "Darkest Lari",
    [MOVE_SPARKLING_ARIA] = "Sparkling Ar",
    [MOVE_ICE_HAMMER] = "Ice Hammer",
    [MOVE_FLORAL_HEALING] = "Floral Heali",
    [MOVE_HIGH_HORSEPOWER] = "High Horsepo",
    ...
    [MOVE_PSYCHIC_TERRAIN] = "Psychic Terr",
    [MOVE_LUNGE] = "Lunge",
    ...
    [MOVE_PURIFY] = "Purify",
    [MOVE_REVELATION_DANCE] = "Revelation D",
    [MOVE_CORE_ENFORCER] = "CoreEnforcer",
    [MOVE_TROP_KICK] = "Trop Kick",
    [MOVE_INSTRUCT] = "Instruct",
    [MOVE_BEAK_BLAST] = "Beak Blast",
    [MOVE_CLANGING_SCALES] = "Clanging Sca",
    [MOVE_DRAGON_HAMMER] = "DragonHammer",
    [MOVE_BRUTAL_SWING] = "Brutal Swing",
    [MOVE_AURORA_VEIL] = "Aurora Veil",
    [MOVE_SHELL_TRAP] = "Shell Trap",
    [MOVE_FLEUR_CANNON] = "Fleur Cannon",
    [MOVE_PSYCHIC_FANGS] = "PsychicFangs",
    [MOVE_STOMPING_TANTRUM] = "Stomping Tan",
    [MOVE_SHADOW_BONE] = "Shadow Bone",
    [MOVE_ACCELEROCK] = "Accelerock",
    [MOVE_LIQUIDATION] = "Liquidation",
    [MOVE_PRISMATIC_LASER] = "Prismatic La",
    [MOVE_SPECTRAL_THIEF] = "Spectral Thi",
    [MOVE_SUNSTEEL_STRIKE] = "Sunsteel Str",
    [MOVE_MOONGEIST_BEAM] = "Moongeist Be",
    [MOVE_TEARFUL_LOOK] = "Tearful Look",
    [MOVE_ZING_ZAP] = "Zing Zap",
    [MOVE_NATURES_MADNESS] = "Nature's Mad",
    [MOVE_MULTI_ATTACK] = "Multi-Attack",
    [MOVE_MIND_BLOWN] = "Mind Blown",
    [MOVE_PLASMA_FISTS] = "Plasma Fists",
    [MOVE_PHOTON_GEYSER] = "PhotonGeyser",
    [MOVE_DOUBLE_IRON_BASH] = "D. Iron Bash",
    //GEN 8
    [MOVE_DYNAMAX_CANNON] = "Dyna Cannon",
    [MOVE_SNIPE_SHOT] = "Snipe Shot",
    [MOVE_JAW_LOCK] = "Jaw Lock",
    [MOVE_STUFF_CHEEKS] = "StuffCheeks",
    [MOVE_NO_RETREAT] = "No Retreat",
    [MOVE_TAR_SHOT] = "Tar Shot",
    [MOVE_MAGIC_POWDER] = "MagicPowder",
    [MOVE_DRAGON_DARTS] = "DragonDarts",
    [MOVE_TEATIME] = "Teatime",
    [MOVE_OCTOLOCK] = "Octolock",
    [MOVE_BOLT_BEAK] = "Bolt Beak",
    [MOVE_FISHIOUS_REND] = "Fishy Rend",
    [MOVE_COURT_CHANGE] = "CourtChange",
    [MOVE_CLANGOROUS_SOUL] = "Clangy Soul",
    [MOVE_BODY_PRESS] = "Body Press",
    [MOVE_DECORATE] = "Decorate",
    [MOVE_DRUM_BEATING] = "Drum Beat",
    [MOVE_SNAP_TRAP] = "Snap Trap",
    [MOVE_PYRO_BALL] = "Pyro Ball",
    [MOVE_BEHEMOTH_BLADE] = "Behemoth Bl",
    [MOVE_BEHEMOTH_BASH] = "Behemoth Ba",
    [MOVE_AURA_WHEEL] = "Aura Wheel",
    [MOVE_BREAKING_SWIPE] = "Break Swipe",
    ...
    [MOVE_STRANGE_STEAM] = "Weird Steam",
    [MOVE_LIFE_DEW] = "Life Dew",
    [MOVE_OBSTRUCT] = "Obstruct",
    [MOVE_FALSE_SURRENDER] = "False Yield",
    [MOVE_METEOR_ASSAULT] = "Meteor Ass.",
